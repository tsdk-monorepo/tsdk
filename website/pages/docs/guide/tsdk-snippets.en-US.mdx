...
- **apii** generate the necessary import
- **apic** generate the api config
- **apin** generate `ApiNameConfig` / `ApiNameReq` / `ApiNameRes`
- **genr** generate `genRoute<ApiNameReq, ApiNameRes>(ApiNameConfig, (data, reqInfo) => {})`
