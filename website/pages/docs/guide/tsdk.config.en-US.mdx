...
- `dataHookLib` - `SWR` | `ReactQuery`，Generate `SWR` or `React Query` hooks;dependencies version: `swr@^2.3.0`; `@tanstack/react-query@^5.10.0`
...
`dataHookLib` - `SWR` | `ReactQuery`; Generate `SWR` or `React Query` hooks;dependencies version: `swr@^2.3.0`; `@tanstack/react-query@^5.64.1`
